...
//SPI
#define SPI1          ((SPI_REG_typedef *)SPI1_Base_Address)
#define SPI2          ((SPI_REG_typedef *)SPI2_Base_Address)
...
//SPI Disable
#define RCC_SPI1_Clock_Disable            (RCC->APB2RSTR |= 1<<12)
#define RCC_SPI2_Clock_Disable            (RCC->APB1RSTR |= 1<<14)
