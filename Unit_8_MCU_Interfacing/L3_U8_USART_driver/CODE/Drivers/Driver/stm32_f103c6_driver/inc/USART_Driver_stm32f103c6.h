...
// Enable/ Disable Polling mechanism.
...
#define Manitessa_MUL100(_pclk_ , _baud_)           (uint32_t)(USARTDIV(_pclk_ , _baud_)) * 100
#define Manitessa(_pclk_ , _baud_)                  (uint32_t)(USARTDIV(_pclk_ , _baud_))
#define DIV_Fraction(_pclk_ , _baud_)               (uint32_t)(((USARTDIV_MUL100(_pclk_ , _baud_) - Manitessa_MUL100(_pclk_ , _baud_)) * 16) / 100)
#define USART_BRR_REG(_pclk_ , _baud_)              (uint32_t)((Manitessa(_pclk_ , _baud_)) << 4) | ((DIV_Fraction(_pclk_ , _baud_)) & 0xF)
