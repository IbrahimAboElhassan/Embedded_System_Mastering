/*
 * EXTI_Driver_stm32f103c6.h
 *
 *  Created on: Oct 6, 2023
 *      Author: Ibrahim Abo Elhassan
 */

#ifndef INC_EXTI_DRIVER_STM32F103C6_H_
#define INC_EXTI_DRIVER_STM32F103C6_H_
...
typedef struct
{
	EXTI_GPIO_Mapping_t EXTI_PIN     ;      // Specifies the internal interrupt GPIO mapping.
	...
	uint8_t             IRQ_Enable   ;      // Enable & Disable the EXTI_IRQ (will mask IRQ in EXTI and NVIC Interrupt controller)
										    // This parameter must be set based on @ref EXIT_IRQ_define.

	void (* P_IRQ_CallBack)(void)    ;      // Set this c function() while will call once the IRQ happened.
...
#endif /* INC_EXIT_DRIVER_STM32F103C6_H_ */
